...
public class MoShengBean {
    ...
    public MoShengBean(String id, String touxiang, String nicheng, String neirong, String huati, String pisize, String time, List<String> imglist, String dianzan, String pinglun) {
        this.id = id;
